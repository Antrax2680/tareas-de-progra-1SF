...
int main() {
	...
	do {
		...
		cout << "1. Imprimir hola mundo desde gotoxy, mostrar un número al centro y mostrar una palabra en distintas cordenadas\n" << endl;
		
		cout << "2. Mostrar cordenadas (30, 30) y mostrar ascii raros luego saludar a un tu compañero\n" << endl;
